...
P0 реализован как конечный single-run: live placement из скамейки во время волн, move/remove/swap на паузе и до первой волны, двухшаговый draft между волнами, save/resume через `localStorage`, победа/поражение и итоговая статистика.
